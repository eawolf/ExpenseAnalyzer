...
INSERT INTO config.PROPERTIES (APPLICATION, PROFILE, LABEL, KEY, VALUE) VALUES ('auth-service', 'default', 'master', 'spring.jpa.properties.hibernate.dialect', 'org.hibernate.dialect.PostgreSQLDialect');
...
INSERT INTO config.PROPERTIES (APPLICATION, PROFILE, LABEL, KEY, VALUE) VALUES ('auth-service', 'prod', 'master', 'spring.jpa.properties.hibernate.dialect', 'org.hibernate.dialect.PostgreSQLDialect');
...
INSERT INTO config.PROPERTIES (APPLICATION, PROFILE, LABEL, KEY, VALUE) VALUES ('expense-service', 'default', 'master', 'spring.jpa.properties.hibernate.dialect', 'org.hibernate.dialect.PostgreSQLDialect');
...
INSERT INTO config.PROPERTIES (APPLICATION, PROFILE, LABEL, KEY, VALUE) VALUES ('expense-service', 'prod', 'master', 'spring.jpa.properties.hibernate.dialect', 'org.hibernate.dialect.PostgreSQLDialect');
